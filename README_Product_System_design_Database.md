...
#### BASE vis-a-vis CAP Theorem
In comparison with the [CAP Theorem](#cap-theorem), BASE chooses availability over consistency.
...
#### NoSQL DB Types: Key-value store
...
###### Key-value store: Best Fit use case
Key-value stores provide high performance and are often used for 
- simple data models or 
- for **rapidly-changing data**, such as an in-memory cache layer.  
...
#### NoSQL DB Types: Document store

> Abstraction: key-value store with documents stored as values

A document store is centered around documents (XML, JSON, binary, etc), where a document stores all information for a given object.  Document stores provide APIs or a query language to query based on the internal structure of the document itself.  *Note, many key-value stores include features for working with a value's metadata, blurring the lines between these two storage types.*

Some document stores like 
- [MongoDB](https://www.mongodb.com/mongodb-architecture) and 
- [CouchDB](https://blog.couchdb.org/2016/08/01/couchdb-2-0-architecture/) also provide a SQL-like language to perform complex queries.  
...
- collections, tags, metadata, or directories.  
...
#### NoSQL DB Types: Wide column store
...
- Google introduced [Bigtable](http://www.read.seas.harvard.edu/~kohler/class/cs239-w08/chang06bigtable.pdf) as the first wide column store, 
- which influenced the open-source [HBase](https://www.mapr.com/blog/in-depth-look-hbase-architecture) often-used in the Hadoop ecosystem, and 
...
- They are relatively new and yet widely-used; 
- Many graphs can only be accessed with [REST APIs](#representational-state-transfer-rest).
...
* clickstream and log data - Rapid ingest of clickstream and log data
* Leaderboard or scoring data
...
#### RDBMS DB Scaling Techniques: Master-slave replication
...
#### RDBMS DB Scaling Techniques: Master-master replication
...
### RDBMS DB Scaling Techniques: Federation
...
### RDBMS DB Scaling Techniques: Sharding
...
### RDBMS DB Scaling Techniques: Denormalization
...
### RDBMS DB Scaling Techniques: SQL tuning
...
####  RDBMS DB Scaling Techniques: Tighten up the schema
...
####  RDBMS DB Scaling Techniques: Use good indices
...
####  RDBMS DB Scaling Techniques: Avoid expensive joins

* [Denormalize](#denormalization) where performance demands it.

####  RDBMS DB Scaling Techniques: Partition tables

* Break up a table by putting hot spots in a separate table to help keep it in memory.

####  RDBMS DB Scaling Techniques: Tune the query cache
